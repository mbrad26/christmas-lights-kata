...
describe('LightsGrid', () => {
  ...
  describe('#turnOFFLights', () => {
    ...
    it('turns all lights OFF in a row', () => {
      ...
      lightsGrid.turnOFFLights(0, 0, 0, 10);
    ...
    it('turns all lights OFF in the first row and 3 lights in second row', () => {
      let count = 0;
      const lightsGrid = new LightsGrid(Light);

      lightsGrid.turnONLights(0, 0, 9, 10);
      lightsGrid.turnOFFLights(0, 0, 1, 3)
    ...
    it('throws an error when arguments are out of boundaries', () => {
      ...
      expect(() => lightsGrid.turnOFFLights(-1, 0, 1, 1)).toThrowError('Out of boundaries!');
      expect(() => lightsGrid.turnOFFLights(0, -1, 1, 1)).toThrowError('Out of boundaries!');
      expect(() => lightsGrid.turnOFFLights(1, 0, -1, 1)).toThrowError('Out of boundaries!');
      expect(() => lightsGrid.turnOFFLights(1, 0, 1, -1)).toThrowError('Out of boundaries!');
      expect(() => lightsGrid.turnOFFLights(11, 0, 1, 1)).toThrowError('Out of boundaries!');
    ...
    it('throws an error when starting in the same row the starting col > ending col', () => {
      ...
      expect(() => lightsGrid.turnOFFLights(0, 5, 0, 1)).toThrowError('Starting col can\'t be greater than ending col!');
    });
  });
});